...
description: "The virtual Linux desktop where Spark performs tasks"
---

## Overview

The Spark Desktop Environment (also called Spark Core) is a complete Linux desktop that runs in a Docker container. This is where Spark does its work - clicking buttons, typing text, browsing websites, and using applications just like you would.

<img
  src="/images/core-container.png"
  alt="Spark Desktop Environment"
