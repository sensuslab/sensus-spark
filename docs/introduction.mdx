...
<p align="center">
  <img
    src="/logo/SparkLogo.svg"
    alt="Spark by Sensus Lab Logo"
    width="500"
  />
</p>

## What is Spark by Sensus Lab?

Spark by Sensus Lab is an open-source AI agent that can control a computer desktop to complete tasks for you. It runs in Docker containers on your own infrastructure, giving you a virtual assistant that can:
...
Simply describe what you need done in plain English, and Spark will figure out how to do it – clicking buttons, typing text, navigating websites, reading documents, and completing tasks just like a human would.

## Why Spark Over Traditional RPA?
...
<CardGroup cols={2}>
  ...
  <Card title="Adaptive Intelligence" icon="brain">
    AI-powered understanding means Spark adapts to UI changes without breaking
  </Card>
...
Spark is the next generation of RPA (Robotic Process Automation). It handles the same complex workflows as traditional tools like UiPath, but with AI-powered adaptability and automatic authentication:
...
Spark becomes even more powerful when combined with coding agents:

- **Full-Stack Testing**: Use a coding agent to generate code, then have Spark visually test and validate the output
- **Automated Debugging**: Let Spark reproduce user-reported issues while a coding agent analyzes and fixes the code
- **End-to-End Development**: Code agents write features, Spark tests them, creating a complete development loop
...
<Steps>
  <Step title="Describe Your Task">
    Simply tell Spark what you want done in natural language through the tasks
    interface
  </Step>
  <Step title="AI Plans the Actions">
    Spark understands your request and breaks it down into specific computer
    actions
  </Step>
  <Step title="Executes Actions">
    Spark executes the task on its virtual desktop using the keyboard
    and mouse
  </Step>
...
Spark consists of four integrated components working together:

<img src="/images/agent-architecture.png" alt="Spark Agent Architecture" />
...
<CardGroup cols={3}>
  <Card title="Quick Start" icon="rocket" href="/quickstart">
    Get Spark running in 2 minutes
  </Card>
...
Just tell Spark what you need done. No coding or complex automation tools required.

### 🖥️ Full Desktop Access
Spark can use any application you can install - browsers, office tools, custom software.

### 🔒 Complete Privacy
Runs entirely on your infrastructure. Your data never leaves your servers.

### 🔄 Two Operating Modes
- **Autonomous Mode**: Spark completes tasks independently
...
- **Task View**: Watch and interact with Spark during task execution
