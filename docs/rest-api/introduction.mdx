---
title: "Introduction"
description: "Overview of the Spark REST API"
---

## Spark REST API

Spark's core functionality is exposed through its REST API, which provides endpoints for interacting with the desktop environment. The API allows for programmatic control of mouse movement, keyboard input, and screen capture.
...
The Spark API does not require authentication by default when accessed locally. For remote access, standard network security practices should be implemented.
