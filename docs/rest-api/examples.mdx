...
description: "Code examples for common automation scenarios using the Spark REST API"
---

This page provides practical examples of how to use the Spark REST API in different programming languages and scenarios.
...
async function fillForm() {
  ...
  await controlComputer("type_text", {
    text: "This is an automated message sent using Spark's Computer Use API",
    delay: 30,
  });
...
You can create a reusable automation framework with Spark:
...
class SparkDriver:
    """A Selenium-like driver for Spark"""
