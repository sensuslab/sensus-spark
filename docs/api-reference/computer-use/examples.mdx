...
description: "Code examples for common automation scenarios using the Spark API"
---
...
await controlComputer("click_mouse", { button: "left" });
    ...
    await controlComputer("type_text", {
      text: "This is an automated test using Node.js and Spark",
      delay: 30
    });
...
# Write a text file
result = write_file("/home/user/hello.txt", "Hello, Spark!")
...
Spark can serve as an alternative to Selenium for web testing:
