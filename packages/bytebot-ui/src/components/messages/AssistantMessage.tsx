...
export function AssistantMessage({
  ...
  return (
    <div className={
      cn(
        "bg-spark-bronze-light-3 flex items-start justify-start gap-2 px-4 py-3 border-x border-spark-bronze-light-7",
        ![TaskStatus.RUNNING, TaskStatus.NEEDS_HELP].includes(taskStatus) && !group.take_over && "border-b border-spark-bronze-light-7 rounded-b-lg"
      )}
    >
      <MessageAvatar role={group.role} />

      {group.take_over ? (
        <div className="border-spark-bronze-light-a6 bg-spark-bronze-light-a1 w-full rounded-2xl border p-2">
          <div className="flex items-center gap-2">
            <Image
              ...
              height={15}
            />
            <p className="text-spark-bronze-light-12 text-[12px] font-medium">
              You took control
            </p>
          </div>
          <div className="bg-spark-bronze-light-2 mt-2 space-y-0.5 rounded-2xl p-1">
